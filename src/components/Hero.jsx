    ...
    <section className="relative min-h-[90vh] flex items-center justify-center pt-32 pb-16 overflow-hidden bg-zinc-950">
      ...
      <div className="max-w-5xl mx-auto px-6 w-full relative z-10">
        ...
        >
          ...
          >
            Computer Science student at Vellore Institute of Technology. Focused
            on{" "}
          ...
          >
            ...
            >
              ...
              <kbd className="hidden sm:inline px-1 py-0.5 rounded bg-zinc-950 text-[9px] text-zinc-500 font-sans border border-zinc-800 ml-1">
                `
              </kbd>
            </button>
