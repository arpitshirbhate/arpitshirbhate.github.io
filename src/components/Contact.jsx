  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      ...
      .catch((err) => {
        ...
        setIsSending(false);
        setError(
          "Failed to transmit message. Please try again or email directly.",
        );
      });
  };
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col mb-16 items-center text-center">
          ...
          <p className="text-zinc-400 mt-4 max-w-xl text-sm sm:text-base leading-relaxed">
            Interested in hiring an intern or collaborating on a data systems
            project? Drop a line below.
          </p>
        </div>
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <p className="text-zinc-400 leading-relaxed text-sm sm:text-base">
                I am actively seeking internship opportunities, research
                collaborations, and open-source platform contributions. I am
                always open to discussing new platform designs, machine learning
                systems, or custom software applications.
              </p>
              ...
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-12 text-center space-y-4">
                  ...
                  <p className="text-zinc-400 text-sm max-w-xs">
                    Thank you! Your message was received successfully. I will
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label
                        ...
                        className="text-xs font-mono font-bold text-zinc-400 uppercase"
                      >
                        Your Name
                      </label>
                      <input
