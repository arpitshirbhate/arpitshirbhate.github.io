...
import { Database, Code2, Cpu, CheckCircle, Globe, Terminal } from 'lucide-react';
...
export const Skills: React.FC = () => {
  const categories: SkillCategory[] = [
    ...
    },
    {
      ...
      accent: 'border-teal-500/20 hover:border-teal-500/40 hover:shadow-teal-500/5',
      skills: ['Pandas', 'NumPy', 'Scikit-learn', 'XGBoost', 'TensorFlow', 'Keras', 'Matplotlib', 'TF-IDF', 'NLP Pipelines', 'Text Classification', 'Recommendation Systems'],
    },
    {
      title: 'Developer Tools',
      icon: <Terminal className="w-5 h-5 text-purple-400" />,
      accent: 'border-purple-500/20 hover:border-purple-500/40 hover:shadow-purple-500/5',
      skills: ['Git', 'GitHub', 'Linux', 'VS Code', 'Vercel', 'Anaconda','IntelliJ','PyCharm', 'Jupyter Notebook', 'Kaggle','Streamlit'],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col mb-16">
          ...
          <p className="text-zinc-400 mt-4 max-w-xl text-sm sm:text-base leading-relaxed">
            A comprehensive overview of libraries, languages, and frameworks that I work with to architect analytical tools and reliable applications.
          </p>
        </div>
          ...
          {categories.map((cat, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white font-display">{cat.title}</h3>
              </div>
