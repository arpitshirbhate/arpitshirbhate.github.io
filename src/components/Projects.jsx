  ...
  const projectsList = [
    {
      title: "Prompt Craft",
      description:
        "A multi-LLM prompt optimization tool that automatically analyzes and enhances user prompts to improve response quality.",
      longDescription:
        "Built with Next.js 15, Gemini, Groq, OpenAI, and Ollama. Includes prompt versioning, side-by-side diff visualization, templates, analytics, and OAuth login.",
      tags: [
        "TypeScript",
        "Next.js",
        "Supabase",
      ...
      architecture: (
        <div className="p-4 rounded-xl bg-zinc-950/80 border border-zinc-800/80 flex flex-col items-center justify-center gap-4 text-xs font-mono font-semibold">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 text-zinc-300 w-full justify-around text-center">
            <div className="px-3 py-2 rounded border border-zinc-800 bg-zinc-900 w-28">
              User Prompt
            </div>
            <ArrowRight className="w-4 h-4 text-primary rotate-90 sm:rotate-0" />
            <div className="px-3 py-2 rounded border border-primary-dark/25 bg-primary-dark/5 w-32 text-primary">
              Multi-LLM Optimizer
            </div>
            <ArrowRight className="w-4 h-4 text-primary rotate-90 sm:rotate-0" />
            <div className="px-3 py-2 rounded border border-zinc-800 bg-zinc-900 w-28">
    ...
    },
    {
      ...
      longDescription:
        "Features real-time GitHub REST API integration to fetch profile details, compute a custom weighted Impact Score, pre-process data with Scikit-Learn pipelines, and classify profiles into Beginner, Advanced, or Elite tiers using an XGBoost model deployed via Streamlit.",
      tags: [
        "Python",
        "Machine Learning",
        "XGBoost",
      ...
      github:
        "https://github.com/arpit2006/GitHub-Developer-Popularity-Tier-Predictor",
      live: "#",
      architecture: (
        <div className="p-4 rounded-xl bg-zinc-950/80 border border-zinc-800/80 flex flex-col items-center justify-center gap-4 text-xs font-mono font-semibold">
          <span className="text-[10px] text-zinc-500 uppercase tracking-widest mb-2">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 text-zinc-300 w-full justify-around text-center">
            ...
            <div className="px-3 py-2 rounded border border-amber-500/25 bg-amber-500/5 w-32 text-amber-400">
              XGBoost Classifier
            </div>
            <ArrowRight className="w-4 h-4 text-amber-400 rotate-90 sm:rotate-0" />
            <div className="px-3 py-2 rounded border border-zinc-800 bg-zinc-900 w-28">
    ...
    },
    {
      ...
      longDescription:
        "Features exploratory data analysis (EDA), handling class imbalance with SMOTE, feature scaling/encoding pipelines, and training classification models (Logistic Regression, Random Forest, XGBoost) optimized using ROC-AUC and F1-score.",
      tags: [
        "Python",
        "Machine Learning",
        "Pandas",
      ...
      architecture: (
        <div className="p-4 rounded-xl bg-zinc-950/80 border border-zinc-800/80 flex flex-col items-center justify-center gap-4 text-xs font-mono font-semibold">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 text-zinc-300 w-full justify-around text-center">
            ...
            <div className="px-3 py-2 rounded border border-indigo-500/25 bg-indigo-500/5 w-32 text-indigo-400">
              Preprocessing & SMOTE
            </div>
            <ArrowRight className="w-4 h-4 text-indigo-400 rotate-90 sm:rotate-0" />
            <div className="px-3 py-2 rounded border border-zinc-800 bg-zinc-900 w-28">
    ...
    },
    {
      ...
      description:
        "An IoT-enabled robot that detects and extinguishes fires automatically using sensors, motors, and pumps with remote monitoring capability.",
      longDescription:
        "Integrated fire sensors, motor drivers, and water pumps with Arduino. Supports remote telemetric monitoring and override controls.",
      tags: [
        "Arduino",
        "C/C++",
        "IoT",
      ...
      architecture: (
        <div className="p-4 rounded-xl bg-zinc-950/80 border border-zinc-800/80 flex flex-col items-center justify-center gap-4 text-xs font-mono font-semibold">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 text-zinc-300 w-full justify-around text-center">
            ...
            <div className="px-3 py-2 rounded border border-teal-500/25 bg-teal-500/5 w-32 text-teal-400">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col mb-16">
          ...
          <p className="text-zinc-400 mt-4 max-w-xl text-sm sm:text-base leading-relaxed">
            A curated showcase of applications built with computational
            scalability, elegant visualization pipelines, and clean
            architectures.
          </p>
        </div>
