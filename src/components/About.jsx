        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <p className="text-zinc-400 leading-relaxed text-sm sm:text-base">
              I am a Computer Science student at VIT-AP focused on building NLP
              pipelines, efficient predictive models, and high-fidelity
              frontends. I design end-to-end data systems that translate complex
              analytical concepts into elegant, responsive user interfaces.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <div className="p-4 rounded-xl border border-zinc-900 bg-zinc-900/40 hover:bg-zinc-900/60 hover:border-primary-dark/20 transition-all group/card flex flex-col justify-between">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-2xl sm:text-3xl font-extrabold text-primary font-display">
                    4+ Stacks
                  </span>
                  <Code2 className="w-5 h-5 text-primary-dark/40 group-hover/card:text-primary transition-colors" />
                </div>
                <p className="text-[10px] text-zinc-500 font-mono group-hover/card:text-zinc-400 transition-colors">
                  Python, Java, DS, SQL
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl border border-zinc-900 bg-zinc-900/40 hover:bg-zinc-900/60 hover:border-secondary-dark/20 transition-all group/card flex flex-col justify-between">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-2xl sm:text-3xl font-extrabold text-secondary font-display">
                    15+ Repos
                  </span>
